...
function planarize_rec(element, planeData){
    planeData.push({node:element.Node, minCoreness: element.minCoreness, maxCoreness: element.maxCoreness, numNodi:element.NumeroNodi, numArchi:element.NumeroArchi})
    if(element.children){
